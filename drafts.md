...
SaSS es un lenguaje preprocesado (que compila) para desarrollar CSS de forma más eficiente. Al ser un lenguaje preprocesado, existen tiempos de compilación y tiempos de ejecución, permitiendo un proceso de Debug más rápido.
SaSS tiene varias evoluciones, hacia SCSS.

Entre las mayores diferncias entre CSS y SCSS:
